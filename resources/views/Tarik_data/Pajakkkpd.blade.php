...
<html lang="en">
    ...
    <body>
                        ...
                        <div class="col">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form method="POST" action="{{ url('simpanjsonkkpd') }}">
                                    @csrf
                                    <div class="card">
                                        <div class="card-body flex flex-col p-6">
                                            <div class="card-text h-full space-y-4">
                                                <div class="input-area">
                                                    ...
                                                    <textarea id="jsontextareakkpd" name="jsontextareakkpd" type="text" class="form-control" rows="10"></textarea>
                                                </div>
                                    ...
                                    <div class="table-responsive">
                                        <table id="zero-conf" class="datatablekkpd display table table-hover" style="width:100%">
                                            <thead>
                                                <tr>
        ...
        @include('Tarik_data.Fungsi.Fungsikkpd')
