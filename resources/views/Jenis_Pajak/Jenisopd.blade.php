...
<html lang="en">
    ...
    <body>
                        ...
                        <div class="col">
                            <div class="card">
                                <div class="card-body table-responsive">
                                        ...
                                        <div class="col-4">
                                            <div class="float-end">
                                                ...
                                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                    <a class="dropdown-item" href="javascript:void(0)" id="createJenispajak" data-toggle="tooltip" data-placement="top" title="klik"> Tambah </a>
                                    ...
                                    <table id="zero-conf" class="tabeljenispajak display table table-hover" style="width:100%">
                                    <thead>
                                            <tr>
                                                <th>No</th>
                                                <th>Jenis Pajak</th>
        ...
        @include('Jenis_Pajak.Modal.Tambah')

        {{-- ############################## Batas Modal ################################ --}}

        {{-- ################################# Fungsi ################################### --}}

        @include('Jenis_Pajak.Fungsi.Fungsi')
