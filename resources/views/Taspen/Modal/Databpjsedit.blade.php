<div class="modal fade bd-example-modal-xl" id="editBpjssipdedit" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table id="tabelbpjssipdriedit" class="table table-hover" style="width:100%">
                                <thead>
                                    <tr>
