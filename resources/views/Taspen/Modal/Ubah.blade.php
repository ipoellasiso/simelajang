<div class="modal fade bd-example-modal-xl" id="ubahbpjs" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            <div class="modal-header">
              ...
              <div class="modal-body">
                    <form id="userubahFormbpjs" name="userubahFormbpjs" method="POST" action="/dtbpjs/ubah" enctype="multipart/form-data">
                        @csrf
                        <div class="modal-body">
