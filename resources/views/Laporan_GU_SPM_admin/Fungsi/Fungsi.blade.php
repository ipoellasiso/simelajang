<script>
    $(document).ready(function(){
        $(document).ready(function () {
            var tampilawal = '1';
            $.ajax({
                url: "{{ route('laporan.pajakguspm.index') }}" +'/' + tampilawal +'/tampilawal',
                type: "GET",
                data: 'tampilawal=' + tampilawal,
                success: function (data) {
                    $('.tampillaporanguspm1').html(data);//menampilkan data ke dalam modal
                }
            });
        });
    });
    ...
    $('body').on('click', '.caribaru', function (e) {
        ...
        var tampilawal = '1';
        $.ajax({
            url: "{{ route('laporan.pajakguspm.index') }}" +'/' + tampilawal +'/tampil',
            type: "GET",
            data: 'nama_skpd=' + nama_skpd + '&nama_pajak_potongan=' + nama_pajak_potongan + '&status1=' + status1,
                success: function (data) {
                    $('.tampillaporanguspm1').html(data);//menampilkan data ke dalam modal
                }
            });
