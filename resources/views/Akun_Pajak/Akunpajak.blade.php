...
<html lang="en">
    ...
    <body>
                        ...
                        <div class="col">
                            <div class="card">
                                <div class="card-body table-responsive">
                                        ...
                                        <div class="col-4">
                                            <div class="float-end">
                                                ...
                                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                    <a class="dropdown-item" href="javascript:void(0)" id="createAkunpajak" data-toggle="tooltip" data-placement="top" title="klik"> Tambah </a>
                                    ...
                                    <table id="zero-conf" class="tabelakunpajak display table table-hover" style="width:100%">
                                    <thead>
                                            <tr>
                                                <th>No</th>
                                                <th>Akun Pajak</th>
        ...
        @include('Akun_Pajak.Modal.Tambah')

        {{-- ############################## Batas Modal ################################ --}}

        {{-- ################################# Fungsi ################################### --}}

        @include('Akun_Pajak.Fungsi.Fungsi')
