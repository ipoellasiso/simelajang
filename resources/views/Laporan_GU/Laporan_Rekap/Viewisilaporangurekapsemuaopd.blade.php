                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-right" style="width: 5%" align="right">
                                                    ...
                                                    {{ number_format($total2 = $datapajakgurekapsemuaopd->where('akun_pajak', '411618')->sum('nilai_pajak'), 0) }} <br>
                                                    {{ number_format($total2 = $datapajakgurekapsemuaopd->where('akun_pajak', '411619')->sum('nilai_pajak'), 0) }}<br>
                                                    {{ number_format($total2 = $datapajakgurekapsemuaopd->where('akun_pajak', '411212')->sum('nilai_pajak'), 0) }}<br>
                                                    {{ number_format($total2 = $datapajakgurekapsemuaopd->where('akun_pajak', '411222')->sum('nilai_pajak'), 0) }}
                                                </td>
                                            </tr>
