                        ...
                        <div class="col">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form method="POST" action="/pajakgu/updateadmin/{{ $dtpajakgu->id }}" enctype="multipart/form-data">
                                    @csrf
                                    <div class="modal-body">
                                        ...
                                        <div class="modal-footer">
                                            <a href="/tampilpajakguadmin" type="button" class="btn btn-outline-danger m-b-xs" data-dismiss="modal">
