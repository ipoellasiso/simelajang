...
<html lang="en">
    ...
    <body style="background-color: white;">
        ...
        {{-- <div class="page-container"> --}}
            ...
            {{-- ######################### Isi Tampil Pajak LS ########################## --}}
                ...
                <div class="row">
                    ...
                    <div class="col-2">
                        <button id="cetakpdflsrekapuser" target="blank" type="button" class="btn btn-outline-primary m-b-xs text-center" style="text-align: center">
        ...
        $(document).ready(function(){
                $("#cetakpdflsrekapuser").click(function(e){
                    ...
                    window.open("/laporanpajaklsrekapuser-cetak"+params,"_blank");
                });
            });
