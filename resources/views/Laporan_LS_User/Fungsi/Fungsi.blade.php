<script>
    $(document).ready(function(){
        $(document).ready(function () {
            var tampilawal = '1';
            $.ajax({
                url: "{{ route('laporan.pajaklsuser.index') }}" +'/' + tampilawal +'/tampilawal',
                type: "GET",
    ...
    $('body').on('click', '.caribaru', function (e) {
        ...
        var tampilawal = '1';
        $.ajax({
            url: "{{ route('laporan.pajaklsuser.index') }}" +'/' + tampilawal +'/tampil',
            type: "GET",
    ...
    $('body').on('click', '.caribarurekap', function (e) {
        ...
        $.ajax({
            url: "{{ route('laporan.pajaklsuser.index') }}" +'/' + tampilawalrekap +'/tampilrekap',
            type: "GET",
